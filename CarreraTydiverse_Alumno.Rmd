...
library(pacman)
p_load(dplyr,lubridate, tidyverse, readr)
...
```{r}
cran2[order(cran2$ip_id, cran2$country,cran2$r_version),decreasing=c(TRUE,TRUE, FALSE)]
```
